...
//          Cilent   point-to-point  |    |    |    |
//                                   ================
//                                     LAN 172.11 .2.0

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("CSMA_Simulation");
...
main (int argc, char *argv[])
{
  ...
  p2pNodes.Create (2); //n0 and n1 will be created
...
//Wireless networks
  ...
  NodeContainer wifiApNode = p2pNodes.Get (0);//n0
...
//YANS - Yet Another Network Simulator
  ...
  address.SetBase ("172.12.3.0", "255.255.255.0");
